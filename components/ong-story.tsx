      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-16 space-y-4">
            <p className="text-[#21A14A] font-semibold text-sm uppercase tracking-wider">Nossa Trajetória</p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 gap-8 items-center">
              <div className="order-1 md:order-2 space-y-4 ">
                <div className="flex items-center gap-3 justify-center">
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#21A14A] flex items-center justify-center text-white font-bold">
                    01
                  </div>
                  <h3 className="text-2xl font-bold text-black">SOS PETS ASSIS</h3>
                </div>
          ...
          <div className="mt-16 pt-16 pb-15 border-t border-b border-slate-200">
            <p className="text-center text-[#21A14A] font-semibold text-sm uppercase tracking-wider mb-8">
              Números que Contam uma História
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-5xl font-bold text-[#21A14A] mb-2">500+</div>
                <p className="text-black font-medium">Vidas Resgatadas</p>
                <p className="text-sm text-black mt-2">Animais que receberam uma segunda chance</p>
              </div>
              <div className="text-center">
                <div className="text-5xl font-bold text-[#0383CE] mb-2">150+</div>
                <p className="text-black font-medium">Voluntários Dedicados</p>
                <p className="text-sm text-black mt-2">Pessoas que fazem a diferença todo dia</p>
              </div>
              <div className="text-center">
                <div className="text-5xl font-bold text-[#21A14A] mb-2">100%</div>
                <p className="text-black font-medium">Amor e Dedicação</p>
                <p className="text-sm text-black mt-2">Em cada ação que tomamos</p>
              </div>
            </div>
          </div>
        </div>
